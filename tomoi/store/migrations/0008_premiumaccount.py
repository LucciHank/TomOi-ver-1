...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0007_productimage_delete_premiumaccount'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('Netflix', 'Netflix'), ('Spotify', 'Spotify'), ('ChatGPT', 'ChatGPT'), ('Others', 'Others')], max_length=50)),
