        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Mã loại tài khoản"
                    ),
                ),
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Tên loại tài khoản"),
                ),
                (
                    "color_code",
                    models.CharField(
                        default="#666666", max_length=7, verbose_name="Mã màu hiển thị"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "balance",
                    models.DecimalField(
                        decimal_places=0, default=0, max_digits=10, verbose_name="Số dư"
                    ),
                ),
                (
                    "join_date",
                    models.DateField(auto_now_add=True, verbose_name="Ngày tham gia"),
                ),
                (
                    "verification_token",
